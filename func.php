...
if(isset($_POST['patsub'])){
	...
	$query="select * from greg where email='$email' and password='$password';";
    ...
    echo("<script>alert('Invalid Username or Password. Try Again!');
          window.location.href = 'guardianlogin.php';</script>");
...
if(isset($_POST['doc_sub']))
{
  ...
  $nurseFees=$_POST['nurseFees'];
	$query="insert into nursetb(username,password,email,nurseFees)values('$nurse','$dpassword','$demail','$nurseFees')";
	$result=mysqli_query($con,$query);
	if($result)
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Revisit</a>
      ...
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">nurses Section</a>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="Revisit.php">
                <div class="row">
                  ...
                  <div class="col-md-4"><label>nurse:</label></div>
                  <div class="col-md-8">
