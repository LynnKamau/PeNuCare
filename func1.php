...
if(isset($_POST['nursesub1'])){
	$dname=$_POST['username3'];
	$dpass=$_POST['password3'];
	$query="select * from nursetb where username='$dname' and password='$dpass';";
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
		...
		header("Location:nursepanel.php");
	}
	else{
...
// {
// 	$name=$_POST['name'];
// 	$query="insert into nursetb(name)values('$name')";
// 	$result=mysqli_query($con,$query);
// 	if($result)
