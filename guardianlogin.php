...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: cursive;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp PeNuCare PLATFORM</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: cursive;"><h6>HOME</h6></a>
          </li>
  
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="services.html" style="color: white;font-family: cursive;"><h6>ABOUT US</h6></a>
          </li>

          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: white;font-family: cursive;"><h6>CONTACT</h6></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/favicon.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

      <div style="color: white;">
            <h4 style="font-family: cursive;"> We are here for you!</h4>
          </div>
          ...
          <div class="card" style="font-family: cursive;">
            <div class="card-body">
              <center>
                ...
                <br>
              <h3 style="margin-top: 10%">Guardian Login</h3><br>
