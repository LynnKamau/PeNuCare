...
$nurse = $_SESSION['dname'];
if(isset($_GET['cancel']))
  {
    $query=mysqli_query($con,"update revisittb set nurseStatus='0' where ID = '".$_GET['ID']."'");
    if($query)
    {
  ...
  //   $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,revdate,revtime,diagnosis,allergy,prescription) values ('$nurse',$pid,$ID,'$revdate','$revtime','$diagnosis','$allergy','$prescription');");
  //   if($query)
  //   {
...
.text-primary {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px; font-family: cursive;"> Welcome &nbsp<?php echo $_SESSION['dname'] ?>  </h3>
      <div class="row">
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Dashboard</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Revisits</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> View Revisits</h4>
                      <script>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,ID,fname,lname,gender,email,contact,revdate,revtime,userStatus,nurseStatus from revisittb where nurse='$dname';";
                    ...
                    if(($row['userStatus']==1) && ($row['nurseStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="nursepanel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                        ...
                        <a href="prescribe.php?pid=<?php echo $row['pid']?>&ID=<?php echo $row['ID']?>&fname=<?php echo $row['fname']?>&lname=<?php echo $row['lname']?>&revdate=<?php echo $row['revdate']?>&revtime=<?php echo $row['revtime']?>"
        ...
        <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,fname,lname,ID,revdate,revtime,diagnosis,allergy,prescription from prestb where nurse='$nurse';";
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="adminpanel.php">
          <div class="row">
                  ...
                  <div class="col-md-8"><input type="text" class="form-control" name="nurse" required></div><br><br>
