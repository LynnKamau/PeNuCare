<?php require_once 'reportcon.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    ...
    <body>
        ...
        <h3 style = "padding-left: 100px; font-family: fantasy;"> Wards Against Nurse Fees Bar Graph</h3>
...
<script type="text/javascript">
      ...
      var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels:<?php echo json_encode($Nurse_Ward); ?>,
                        datasets: [{
                            backgroundColor: [
                               "#5969aa",
                                "#ff407b",
